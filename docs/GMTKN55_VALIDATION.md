...
(the q-loop's carbene charge override) reached **0.447**, with `G21EA` 0.653 -> 0.131.
...
> the categories that remain. Current state: MAD 0.447 / RMSD 3.81 / max 105.5, with
> 116 of 2458 structures above 1 kcal/mol and 13 above 20.
>
