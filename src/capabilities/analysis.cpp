...
void UnifiedAnalysis::outputResults(const json& results)
{
    ...
    if (output_format == "json") {
        CurcumaLogger::raw(std::setw(2), results);
...
{
    CurcumaLogger::raw("Enhanced Topological Data Analysis (dMatrix Alternative)");
    CurcumaLogger::raw("=========================================================");
    std::cout << std::endl;
    CurcumaLogger::raw("OVERVIEW:");
    CurcumaLogger::raw("The enhanced TDA functionality provides comprehensive topological data analysis");
    CurcumaLogger::raw("for molecular structures, equivalent to the legacy -dMatrix command but with");
    CurcumaLogger::raw("modern integration into the unified analysis system.");
    std::cout << std::endl;
    CurcumaLogger::raw("MIGRATION FROM -dMatrix:");
    CurcumaLogger::raw("Old usage: curcuma -dMatrix molecule.xyz");
    CurcumaLogger::raw("New usage: curcuma -analysis molecule.xyz -topological.save_persistence_image true");
    std::cout << std::endl;
    CurcumaLogger::raw("CORE FEATURES:");
    std::cout << std::endl;
    CurcumaLogger::raw("1. Distance Matrix Analysis");
    CurcumaLogger::raw("   -topological.save_distance_matrix true");
    CurcumaLogger::raw("   • Exports complete distance matrix (.dMat files)");
    CurcumaLogger::raw("   • Includes atomic elements and energies if requested");
    CurcumaLogger::raw("   • Supports bond exclusion for topological analysis");
    std::cout << std::endl;
    CurcumaLogger::raw("2. Persistent Homology Analysis");
    CurcumaLogger::raw("   -topological.save_persistence_pairs true");
    CurcumaLogger::raw("   • Generates persistence pairs (.pairs files)");
    CurcumaLogger::raw("   • Calculates birth-death persistence data");
    CurcumaLogger::raw("   • Provides topological invariants and statistics");
    std::cout << std::endl;
    CurcumaLogger::raw("3. Persistence Diagrams");
    CurcumaLogger::raw("   -topological.save_persistence_diagram true");
    CurcumaLogger::raw("   • Creates persistence diagram matrices (.PD files)");
    CurcumaLogger::raw("   • Exports both text and image formats");
    CurcumaLogger::raw("   • Supports multiple colormaps and post-processing");
    std::cout << std::endl;
    CurcumaLogger::raw("4. Persistence Images");
    CurcumaLogger::raw("   -topological.save_persistence_image true");
    CurcumaLogger::raw("   • Generates persistence images (.PI files)");
    CurcumaLogger::raw("   • EN-scaled bond topology analysis");
    CurcumaLogger::raw("   • Advanced image processing and enhancement");
    std::cout << std::endl;
    CurcumaLogger::raw("ADVANCED CONFIGURATION:");
    std::cout << std::endl;
    CurcumaLogger::raw("Molecular Filtering:");
    CurcumaLogger::raw("  -topological.exclude_hydrogen true     # Remove H atoms from analysis");
    CurcumaLogger::raw("  -topological.exclude_bonds true        # Exclude bonded atom pairs");
    CurcumaLogger::raw("  -topological.print_elements true       # Include element symbols");
    CurcumaLogger::raw("  -topological.print_energy true         # Include molecular energies");
    std::cout << std::endl;
    CurcumaLogger::raw("Image Generation:");
    CurcumaLogger::raw("  -topological.image_format png|jpg|bmp|tga");
    CurcumaLogger::raw("  -topological.colormap grayscale|jet|hot|viridis|coolwarm");
    CurcumaLogger::raw("  -topological.resolution 800x600|1024x1024|2048x2048");
    std::cout << std::endl;
    CurcumaLogger::raw("Post-Processing:");
    CurcumaLogger::raw("  -topological.post_processing none|adaptive|ring_focused");
    CurcumaLogger::raw("  -topological.temperature 2.0           # Enhancement temperature parameter");
    CurcumaLogger::raw("  -topological.damping 1.5               # Damping strength for processing");
    CurcumaLogger::raw("  -topological.preserve_structure true   # Maintain original structure");
    std::cout << std::endl;
    CurcumaLogger::raw("MULTI-STRUCTURE & TRAJECTORY ANALYSIS:");
    CurcumaLogger::raw("The enhanced TDA supports batch processing of molecular trajectories and");
    CurcumaLogger::raw("multi-structure files with automatic detection:");
    std::cout << std::endl;
    CurcumaLogger::raw("Supported Multi-Structure Formats:");
    CurcumaLogger::raw("• XYZ trajectories (.trj.xyz, multi-frame .xyz)");
    CurcumaLogger::raw("• VTF trajectories (.vtf with multiple timesteps)");
    CurcumaLogger::raw("• MOL2, SDF multi-structure files");
    std::cout << std::endl;
    CurcumaLogger::raw("Usage Examples:");
    CurcumaLogger::raw("  curcuma -analysis trajectory.trj.xyz -topological.save_distance_matrix true");
    CurcumaLogger::raw("  curcuma -analysis dynamics.vtf -topological.save_persistence_image true");
    CurcumaLogger::raw("  curcuma -analysis multi_conf.xyz -topological.save_persistence_pairs true");
    std::cout << std::endl;
    CurcumaLogger::raw("Auto-Detection Features:");
    CurcumaLogger::raw("• Automatic multi-structure detection (legacy dMatrix compatibility)");
    CurcumaLogger::raw("• Per-frame analysis with automatic indexing");
    CurcumaLogger::raw("• VTF timestep parsing with structure template preservation");
    CurcumaLogger::raw("• Progress reporting for large trajectory files");
    CurcumaLogger::raw("• Statistical analysis across trajectory (average, standard deviation)");
    CurcumaLogger::raw("• Correlation analysis between frames");
    CurcumaLogger::raw("• Batch export of all persistence data");
    std::cout << std::endl;
    CurcumaLogger::raw("OUTPUT FILES:");
    CurcumaLogger::raw("The system generates indexed files for each analysis type:");
    std::cout << std::endl;
    CurcumaLogger::raw("• prefix_N.dMat     - Distance matrix (text format)");
    CurcumaLogger::raw("• prefix_N.pairs    - Persistence pairs (birth-death values)");
    CurcumaLogger::raw("• prefix_N.PD       - Persistence diagram (matrix format)");
    CurcumaLogger::raw("• prefix_N.PD.png   - Persistence diagram (image)");
    CurcumaLogger::raw("• prefix_N.PI       - Persistence image (matrix format)");
    CurcumaLogger::raw("• prefix_N.PI.png   - Persistence image (visualization)");
    std::cout << std::endl;
    CurcumaLogger::raw("Where N is the frame index (0 for single structures).");
    std::cout << std::endl;
    CurcumaLogger::raw("RESEARCH APPLICATIONS:");
    CurcumaLogger::raw("This implementation is suitable for:");
    CurcumaLogger::raw("• Molecular shape analysis and comparison");
    CurcumaLogger::raw("• Protein folding and conformational studies");
    CurcumaLogger::raw("• Materials science and crystal structure analysis");
    CurcumaLogger::raw("• Drug discovery and molecular recognition");
    CurcumaLogger::raw("• Machine learning feature generation");
    std::cout << std::endl;
    CurcumaLogger::raw("CITATION:");
    CitationRegistry::cite("ripser");
    std::cout << std::endl;
    CurcumaLogger::raw("EXAMPLES:");
    std::cout << std::endl;
    CurcumaLogger::raw("Basic persistence analysis:");
    CurcumaLogger::raw("  curcuma -analysis molecule.xyz -topological.save_persistence_pairs true");
    std::cout << std::endl;
    CurcumaLogger::raw("Complete TDA workflow:");
    CurcumaLogger::raw("  curcuma -analysis structure.xyz \\");
    CurcumaLogger::raw("          -topological.save_distance_matrix true \\");
    CurcumaLogger::raw("          -topological.save_persistence_diagram true \\");
    CurcumaLogger::raw("          -topological.save_persistence_image true");
    std::cout << std::endl;
    CurcumaLogger::raw("High-quality images without hydrogen:");
    CurcumaLogger::raw("  curcuma -analysis protein.pdb \\");
    CurcumaLogger::raw("          -topological.save_persistence_image true \\");
    CurcumaLogger::raw("          -topological.exclude_hydrogen true \\");
    CurcumaLogger::raw("          -topological.colormap viridis \\");
    CurcumaLogger::raw("          -topological.resolution 2048x2048 \\");
    CurcumaLogger::raw("          -topological.image_format png");
    std::cout << std::endl;
    CurcumaLogger::raw("Trajectory analysis with post-processing:");
    CurcumaLogger::raw("  curcuma -analysis dynamics.trj.xyz \\");
    CurcumaLogger::raw("          -trajectory true \\");
    CurcumaLogger::raw("          -topological.save_persistence_image true \\");
    CurcumaLogger::raw("          -topological.post_processing adaptive \\");
    CurcumaLogger::raw("          -topological.temperature 3.0");
    std::cout << std::endl;
    CurcumaLogger::raw("VTF trajectory analysis (coarse-grained systems):");
    CurcumaLogger::raw("  curcuma -analysis polymer_dynamics.vtf \\");
    CurcumaLogger::raw("          -topological.save_distance_matrix true \\");
    CurcumaLogger::raw("          -topological.save_persistence_image true \\");
    CurcumaLogger::raw("          -topological.exclude_bonds true");
    std::cout << std::endl;
    CurcumaLogger::raw("Multi-structure file with automatic detection:");
    CurcumaLogger::raw("  curcuma -analysis conformers.xyz \\");
    CurcumaLogger::raw("          -topological.save_persistence_pairs true");
    CurcumaLogger::raw("  # Automatically processes all structures in the file");
    std::cout << std::endl;
}
