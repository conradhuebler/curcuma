...
/// Caller must zero d_Cz1 and d_S before launch (hipMemsetAsync).
...
// 1-thread-per-atom helpers used by EEQSolverHip::solveSinglePCG.
// Matvec / dot / axpy go via cuBLAS (hipblasDsymv / Ddot / Daxpy).
// ============================================================================
...
/// d_Ax must hold A·x (precomputed via hipblasDsymv).
