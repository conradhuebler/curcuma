/*
 * <FFWorkspaceHip - CUDA-Accelerated GFN-FF Workspace>
 ...
 * (FFWorkspaceHipImpl, defined in ff_workspace_gpu.cu).
 *
...
// ---------------------------------------------------------------------------
// FFWorkspaceHip — GPU-accelerated GFN-FF energy and gradient
// ---------------------------------------------------------------------------
/**
 ...
 *
 * Usage:
 *   FFWorkspaceHip gpu_ws(params, natoms, atom_types);
...
public:
     ...
     */
    explicit FFWorkspaceHip(const GFNFFParameterSet& params,
                             int natoms,
    ...
    FFWorkspaceHip(const FFWorkspaceHip&)             = delete;
    FFWorkspaceHip& operator=(const FFWorkspaceHip&)  = delete;
...
private:
    std::unique_ptr<FFWorkspaceHipImpl> m_impl;
