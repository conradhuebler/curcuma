...
- ⚠️ **Native GFN1/GFN2 ALPB** (June 2026, AI/machine-tested) - self-consistent ALPB
  in the native xTB SCF, matching tblite total ΔG (Born + CDS + shift; CM5 for gfn1)
  to ≤1e-8 Eh on the validation set; `-method gfn2 -xtb.solvent water -xtb.solvent_model 3`.
  CPCM/GBSA/GPU/GFN-FF native solvation still pending. See [docs/SQM_SOLVATION_WP.md](docs/SQM_SOLVATION_WP.md)
