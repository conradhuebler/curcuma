...
- ⚠️ **GFN2-xTB (Native)** - AI-implemented, machine-tested; canonical `gfn2` backend since AP3; `-opt` works (AP4); ~35–60 mEh off TBLite (AP5 pending)
- ⚠️ **GFN1-xTB (Native)** - AI-implemented, machine-tested; canonical `gfn1` backend since AP3; `-opt` works (AP4); ~5–70 mEh off TBLite (AP5 pending)
